...
public class TransferenciaService {
	...
	public Transferencia agendarTransferencia(TransferenciaRequestDTO transferenciaRequestDTO) throws Exception {
    ...
    private void validarTransferencia(Transferencia transferencia) throws Exception {
        if (transferencia.getDataTransferencia().isBefore(LocalDate.now())) {
            throw new Exception("Data da transferência deve ser posterior à data atual");
        }
    ...
    private Double calcularTaxa(LocalDate dataTransferencia) throws Exception {
